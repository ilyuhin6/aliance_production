...
<body>
  ...
  <header class="header header-page header-content-post">
    <div class="container">
      <div class="header-content-page">
        <div class="separator"></div>
        <h1 class="header-title header-title-page header-title-post">
          Современная методология разработки одухотворила всех причастных
        </h1>
        <ul class="breadcrumb-list list-post">
          <li class="breadcrumb-item"><a href="/" class="breadcrumb-link link-post">Главная</a></li>
          <li class="breadcrumb-item"><a href="/" class="breadcrumb-link link-post">Блог</a></li>
          <li class="breadcrumb-item">Современная методология разработки одухотворила всех причастных</li>
        </ul>
      </div>
    </div>
  </header>
